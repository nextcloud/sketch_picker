OC.L10N.register(
    "sketch_picker",
    {
    "Draw a sketch" : "Dessiner un croquis",
    "Sketch picker" : "Sélecteur de croquis",
    "Quickly draw and share sketches" : "Dessiner et partager rapidement des croquis",
    "This app adds a smart picker provider to quickly draw sketches and insert them in your current context." : "Cette application ajoute un fournisseur au sélecteur intelligent pour tracer rapidement des croquis et les insérer dans votre contexte actuel.",
    "Error saving image" : "Erreur lors de l'enregistrement de l'image",
    "Really?" : "Vraiment ?",
    "Unsaved changes" : "Modifications non enregistrées",
    "Drop changes" : "Abandonner les modifications",
    "Cancel" : "Annuler",
    "Loading sketch" : "Chargement du croquis",
    "Choose a file to draw a sketch on" : "Choisissez un fichier sur lequel dessiner un croquis",
    "Failed to save image" : "Impossible d’enregistrer l'image",
    "Unknown Sketch Picker API error" : "Erreur inconnue de l'API du Sélecteur de croquis",
    "Open from Files" : "Ouvrir depuis Fichiers",
    "Open recently seen sketch" : "Ouvrir un croquis vu récemment",
    "Name" : "Nom",
    "Post sketch" : "Envoyer le croquis",
