OC.L10N.register(
    "sketch_picker",
    {
    "Draw a sketch" : "Нарисовать эскиз",
    "Sketch picker" : "Выбор эскиза",
    "Quickly draw and share sketches" : "Быстро рисуйте и делитесь эскизами",
    "This app adds a smart picker provider to quickly draw sketches and insert them in your current context." : "В это приложение добавлен поставщик интеллектуальных средств выбора, позволяющий быстро рисовать эскизы и вставлять их в текущий контекст.",
    "Error saving image" : "Не удалось сохранить изображение",
    "Really?" : "Действительно?",
    "Unsaved changes" : "Несохранённые изменения",
    "Drop changes" : "Отменить изменения",
    "Cancel" : "Cancel",
    "Loading sketch" : "Загрузка эскиза",
    "Choose a file to draw a sketch on" : "Выберите файл, на котором хотите нарисовать эскиз",
    "Failed to save image" : "Не удалось сохранить изображение",
    "Unknown Sketch Picker API error" : "Неизвестная ошибка API Sketch Picker",
    "Open from Files" : "Открыть из Файлов",
    "Open recently seen sketch" : "Открыть недавно просмотренный эскиз",
    "Name" : "Имя",
    "Post sketch" : "Опубликовать эскиз",
