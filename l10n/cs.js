OC.L10N.register(
    "sketch_picker",
    {
    "Draw a sketch" : "Nakreslit náčrtek",
    "Sketch picker" : "Výběr náčrtu",
    "Quickly draw and share sketches" : "Rychle kreslete a sdílejte náčrtky",
    "This app adds a smart picker provider to quickly draw sketches and insert them in your current context." : "Tato aplikace přidá poskytovatele inteligentního výběru pro rychlé kreslení náčrtků a jejich vkládání do stávajícího kontextu.",
    "Error saving image" : "Chyb při ukládání obrázku",
    "Really?" : "Opravdu?",
    "Unsaved changes" : "Neuložené změny",
    "Drop changes" : "Zahodit změny",
    "Cancel" : "Zrušit",
    "Loading sketch" : "Načítání náčrtu",
    "Choose a file to draw a sketch on" : "Vyberte soubor na kterém kreslit náčrt",
    "Failed to save image" : "Obrázek se nepodařilo uložit",
    "Unknown Sketch Picker API error" : "Neznámá chyba API pro výběr náčrtků",
    "Open from Files" : "Otevřít ze souborů",
    "Open recently seen sketch" : "Otevřít nedávno zobrazené náčrtky",
    "Name" : "Název",
    "Post sketch" : "Odeslat náčrt",
    "Save as" : "Uložit jako",
    "Back" : "Zpět",
    "Loading …" : "Načítání…",
